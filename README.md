...
# Analysis
This sequencing tool leverages STRs, allowing users to take DNA sequences of any length, and match them to a database of individuals and their known sequences. As such, this is an especially useful forensic tool, which is very often used for human identification purposes.
